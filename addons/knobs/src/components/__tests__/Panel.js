...
//   const context = shallow(<ThemeProvider theme={themes.light} />)
//     .instance()
//     .getChildContext();
...
//     it.only('should have no tabs when there are no groupIds', () => {
...
//       const wrapper = mountWithTheme(<Panel channel={testChannel} api={testApi} active />);
