...
//   .add('stateful - bordered', () => <TabsState panels={panels} bordered />)
//   .add('stateful - absolute', () => <TabsState panels={panels} absolute />)
//   .add('stateful - absolute & bordered', () => <TabsState panels={panels} absolute bordered />)
//   .add('stateless - default', () => (
//     <Tabs panels={panels} onPanelSelect={onPanelSelect} selectedPanel="test2" />
//   ))
...
storiesOf('Components|Tabs', module)
  ...
  .add('stateless - bordered', () => (
    <Tabs bordered absolute={false} selectedPanel="test3">
      {content}
    </Tabs>
  ))
  .add('stateless - absolute', () => (
    <Tabs bordered absolute selectedPanel="test3">
      {content}
    </Tabs>
  ))
  .add('stateless - empty', () => <Tabs onPanelSelect={onPanelSelect} />);
