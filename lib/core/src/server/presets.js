...
function applyPresets(presets, config, args = {}, extension) {
  ...
  return presets.reduce((acc, { preset, options }) => {
  ...
  //     };
  //
  //     presetResult = presetResult.then(newConfig => {
  //       return context.extensionFn.call(context.preset, newConfig, context.combinedOptions);
  //     });
  //   }
  // });
  //
