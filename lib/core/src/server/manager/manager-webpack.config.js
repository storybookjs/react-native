...
const r = require.resolve('@storybook/ui/package.json').replace('package.json', '');
const context = path.join(r, '../../node_modules');
  ...
  return {
    ...
    plugins: [
      new webpack.DllReferencePlugin({
        context,
        manifest: path.join(r, '/dll/storybook_ui-manifest.json'),
      }),
      ...
      //   outputPath: path.join(cacheDir, './manager-profileEvents.json'),
      // }),
    ],
    resolve: {
