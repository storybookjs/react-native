...
describe('resolveAddonName', () => {
  ...
  it('should resolve packages with metadata (relative path)', () => {
    expect(resolveAddonName('@storybook/addon-docs', options)).toEqual({
  ...
  it('should resolve packages with metadata (absolute path)', () => {
    expect(resolveAddonName('@storybook/addon-knobs', options)).toEqual({
  ...
  it('should resolve packages without metadata', () => {
    expect(resolveAddonName('@storybook/preset-create-react-app', options)).toEqual({
  ...
  it('should resolve managerEntries', () => {
    expect(resolveAddonName('@storybook/addon-actions/register', options)).toEqual({
  ...
  it('should resolve presets', () => {
    expect(resolveAddonName('@storybook/addon-docs/preset', options)).toEqual({
      name: '@storybook/addon-docs/preset',
      type: 'presets',
    });
  });
  ...
  it('should resolve preset packages', () => {
    expect(resolveAddonName('@storybook/addon-essentials', options)).toEqual({
  ...
  it('should error on invalid inputs', () => {
    expect(() => resolveAddonName(null, options)).toThrow();
  });
});
...
describe('splitAddons', () => {
  ...
  it('should split managerEntries that end in register', () => {
    ...
    expect(splitAddons(addons, options)).toEqual({
