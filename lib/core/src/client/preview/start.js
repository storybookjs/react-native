...
const applyLayout = memoize(1)(layout => {
  switch (layout) {
    case 'centered': {
      document.body.style =
        'margin: 0px;display: flex;justify-content: center;align-items: center;min-height: 100vh;padding: 1rem;box-sizing: border-box;';
      break;
    }
    case 'fullscreen': {
    ...
    case 'padded':
    default: {
      document.body.style = 'margin: 0;padding: 1rem';
      break;
    }
  }
});
