...
describe('manager.api.actions.api', () => {
  ...
  describe('selectInCurrentKind', () => {
    it('should select the correct story', () => {
      const clientStore = new MockClientStore();
      actions.selectInCurrentKind({ clientStore }, 'y');
    ...
    it("should select the first story if there's no such story", () => {
      const clientStore = new MockClientStore();
      actions.selectInCurrentKind({ clientStore }, 'y');
  ...
  describe('setOptions', () => {
    it('should update options', () => {
      const clientStore = new MockClientStore();
      actions.setOptions({ clientStore }, { name: 'test' });

      const stateUpdates = clientStore.updateCallback({});
      expect(stateUpdates.uiOptions).toMatchObject({ name: 'test' });
    });
    ...
    it('should only update options for the key already defined', () => {
      const clientStore = new MockClientStore();
      actions.setOptions({ clientStore }, { name: 'test', random: 'value' });
