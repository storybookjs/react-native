...
const AboutScreen = ({ latest, current, onClose }) => {
  ...
  if (latest) {
    if (canUpdate) {
      ...
      updateMessage = <UpdateMessage status="neutral">You're up to date</UpdateMessage>;
    }
  } else {
    updateMessage = (
            ...
            {latest ? (
              ...
              <Fragment>
                <Link
                  ...
                  withArrow
                >
                  View the release history instead
                </Link>
              </Fragment>
            )}
            ...
            {canUpdate && (
              <Upgrade>
                <DocumentFormatting>
                  ...
                  <p>
                    Alternatively, if you're using a yarn run the following command, and check all
