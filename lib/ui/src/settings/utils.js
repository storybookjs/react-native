...
export const intitShortcutKeys = () => {
  let shortcutKeys = JSON.parse(localStorage.getItem('shortcutKeys'));
  if (!shortcutKeys) {
    shortcutKeys = JSON.stringify(defaultKeyboardShortcuts);
    localStorage.setItem('shortcutKeys', shortcutKeys);
  }
