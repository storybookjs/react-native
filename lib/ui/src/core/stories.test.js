  ...
  describe('jumpToStory', () => {
    it('works forward', () => {
      ...
      const {
        ...
        state,
      } = initStories({ store, navigate, storyId: 'a--1', viewMode: 'components' });
    ...
    it('works backwards', () => {
      ...
      const {
        api: { setStories, jumpToStory },
        state,
      } = initStories({ store, navigate, storyId: 'a--2', viewMode: 'components' });
      store.setState(state);
      setStories(storiesHash);
    ...
    it('does nothing if you are at the last story and go forward', () => {
      ...
      const {
        api: { setStories, jumpToStory },
        state,
      } = initStories({ store, navigate, storyId: 'b-c--1', viewMode: 'components' });
      store.setState(state);
      setStories(storiesHash);
