...
const createMenu = memoize(1)((api, shortcutKeys, isFullscreen, showPanel, showNav, panelPosition) => [
  {
    id: 'about',
...
export default props => <Consumer>{({ state, api }) => <Nav {...props} {...mapper(state, api)} />}</Consumer>;
