...
switch (projectType) {
  ...
  case types.WEBPACK_VUE:
    // eslint-disable-next-line
    require('../generators/WEBPACK_VUE')
      .then(commandLog('Adding storybook support to your "Webpack Vue" app'))
      .then(end);
    break;

  case types.BROWSERIFY_VUE:
    // eslint-disable-next-line
    require('../generators/BROWSERIFY_VUE')
      .then(commandLog('Adding storybook support to your "Browserify Vue" app'))
      .then(end);
    break;
