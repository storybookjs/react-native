...
module.exports = function detect(options) {
  ...
  if (packageJson.devDependencies && packageJson.devDependencies['vue-loader']) {
    return types.WEBPACK_VUE;
  }

  if (packageJson.devDependencies && packageJson.devDependencies.vueify) {
    return types.BROWSERIFY_VUE;
  }
