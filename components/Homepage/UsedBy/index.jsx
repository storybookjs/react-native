...
const UsedByBg = ({ color }) => (
  <div className="used-by-bg">
    <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 1440 380" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <g id="Canvas" transform="translate(618 -3261)">
        <use xlinkHref="#path0_fill" transform="translate(-618 3261.5)" fill={color} id="used-by-bg" />
      </g>
      <defs>
...
const User = ({ logo, demo, site, title }) => (
  <a className="used-by-user" href={demo || site}>
