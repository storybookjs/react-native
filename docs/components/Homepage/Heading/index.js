  ...
  >
    ...
    <g id="Canvas" transform="matrix(2 0 0 2 856 -2058)">
      ...
      <g id="storybook-logo-new">
        <use xlinkHref="#path0_fill" transform="translate(-347 1104)" fill="#AD76B8" id="Vector" />
        <g id="Group">
          <mask id="mask0_alpha">
            <use
              xlinkHref="#path1_fill"
              transform="translate(-333 1090)"
              fill="#ED5B87"
              id="Vector"
            />
          </mask>
        ...
        <use xlinkHref="#path9_fill" transform="translate(-293 1130)" fill="#FFF" id="S" />
      </g>
    </g>
    <defs>
